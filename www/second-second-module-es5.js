...
var SecondPage = /** @class */ (function () {
    function SecondPage(route, http, modalCtrl) {
        this.route = route;
        this.http = http;
    ...
    SecondPage.prototype.ngOnInit = function () {
        ...
        this.http.get('https://www.journalfilter.com/Api.php?q=3months&discipline=cardiology' + this.slug).subscribe(function (res) {
            _this.information = res;
            _this.spinner = false;
            _this.contents = true;
        });
    };
    SecondPage.prototype.filterFunction = function (event) {
        var _this = this;
        this.spinner = true;
        this.contents = false;
        if (event.detail.value == 'recent') {
            this.slug = this.route.snapshot.paramMap.get('title');
            this.title = this.route.snapshot.paramMap.get('name');
            this.http.get('https://www.journalfilter.com/Api.php?q=week&discipline=cardiology' + this.slug + '&search=' + this.search).subscribe(function (res) {
                _this.information = res;
                _this.spinner = false;
                _this.contents = true;
            });
        ...
        if (event.detail.value == 'lastone') {
            this.slug = this.route.snapshot.paramMap.get('title');
            this.title = this.route.snapshot.paramMap.get('name');
            this.http.get('https://www.journalfilter.com/Api.php?q=month&discipline=cardiology' + this.slug + '&search=' + this.search).subscribe(function (res) {
                _this.information = res;
                _this.spinner = false;
                _this.contents = true;
            });
        ...
        if (event.detail.value == 'lastthree') {
            this.slug = this.route.snapshot.paramMap.get('title');
            this.title = this.route.snapshot.paramMap.get('name');
            this.http.get('https://www.journalfilter.com/Api.php?q=3months&discipline=cardiology' + this.slug + '&search=' + this.search).subscribe(function (res) {
                _this.information = res;
                _this.spinner = false;
                _this.contents = true;
            });
        ...
        if (event.detail.value == 'lastyear') {
            this.slug = this.route.snapshot.paramMap.get('title');
            this.title = this.route.snapshot.paramMap.get('name');
            this.http.get('https://www.journalfilter.com/Api.php?q=year&discipline=cardiology' + this.slug + '&search=' + this.search).subscribe(function (res) {
                _this.information = res;
                _this.spinner = false;
                _this.contents = true;
            });
    ...
    SecondPage.prototype.openModal = function (index) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var tmp, tmp1, tmp2, modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tmp = this.information[index].link.doi;
                    ...
                    case 1:
                        modal = _a.sent();
                        this.http.get('https://www.journalfilter.com/Api.php?hitrate=1&pmid=' + this.information[index].article_id).subscribe(function (res) {
                            console.log(res);
                        });
                        modal.present();
                        return [2 /*return*/];
