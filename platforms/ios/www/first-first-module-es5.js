...
var FirstPageRoutingModule = /** @class */ (function () {
    function FirstPageRoutingModule() {
    }
...
var FirstPage = /** @class */ (function () {
    function FirstPage(http, navCtrl, route, router) {
        var _this = this;
        this.http = http;
        ...
        this.route.queryParams.subscribe(function (params) {
            _this.http.get('https://www.journalfilter.com/Api.php?discipline=cardiology&getmenu=topics').subscribe(function (res) {
                _this.information = res['item'];
                _this.spinner = false;
            });
        });
    }
    ...
    FirstPage.prototype.pushpage = function (i, j) {
        this.url = this.information[i].children[j].url;
        var title = this.information[i].children[j].name;
        this.navCtrl.navigateForward(['/second/', this.url, title]);
    };
    FirstPage.prototype.toggleSection = function (index) {
    ...
    FirstPage.prototype.toggleItem = function (index, childIndex) {
