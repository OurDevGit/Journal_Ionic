...
var HomePage = /** @class */ (function () {
    function HomePage(http, navCtrl, router) {
        var _this = this;
        this.http = http;
        ...
        this.spinner = true;
        this.http.get('https://www.journalfilter.com/Api.php?discipline=cardiology&getmenu=topics').subscribe(function (res) {
    ...
    HomePage.prototype.pushpage = function (i, j) {
    ...
    HomePage.prototype.toggleSection = function (index) {
    ...
    HomePage.prototype.toggleItem = function (index, childIndex) {
